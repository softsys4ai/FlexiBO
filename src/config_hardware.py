...
class ConfigHardware(object):
    ...
    def process(self,
        ...
        """
        if cur_config[0]==1:
            proc_config=[1,0,0,0,cur_config[1],cur_config[2],cur_config[3]]
        elif cur_config[0]==2:
            proc_config=[1,1,0,0,cur_config[1],cur_config[2],cur_config[3]]
        elif cur_config[0]==3:
            proc_config=[1,1,1,0,cur_config[1],cur_config[2],cur_config[3]]
        elif cur_config[0]==4:
            proc_config=[1,1,1,1,cur_config[1],cur_config[2],cur_config[3]]
        else:
